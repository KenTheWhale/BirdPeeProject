...
public class SendOTPRegister extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           HttpSession ss = request.getSession();
            ...
            if (BirdPeeDAO.ACCOUNT_checkExistedCustomerByEmail(mail).getFullname() != null) {
                ...
                message.setSubject("BirdPee: Register OTP");
                String htmlContent = ""
                        + "<h3>This code below is your OTP to register your account. Please DO NOT share this code to anyone due to your security</h3>"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SendOTPRegister.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
